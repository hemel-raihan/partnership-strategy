<template>
    <div class="content">
      <div class="container-fluid">
        <breadcrumb :options="['Permissions']"/>
        <div class="row">
          <div class="col-xl-12">
            <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <ValidationObserver v-slot="{ handleSubmit }">
                      <form class="form-horizontal" @submit.prevent="handleSubmit(onSubmit)">
                        <!--                      <ValidationProvider name="User" mode="eager" rules="required" v-slot="{ errors }">-->
                        ...
                        <!--                              </option>-->
                        <!--                            </select>-->
                        <!--                            <submit-form class="ml-1" name="Search"/>-->
                        <!--                          </div>-->
                  ...
                  <div class="col-12">
                    <tree-view v-if="isLoading" :treeList="treeList" :userId="userId" :permission="permission"
  ...
  export default {
    ...
    methods: {
      onSubmit() {
        ...
        if (UserID) {
          this.userId = UserID;
          this.axiosGet('get-user-menu-details/' + this.userId, (response) => {
            this.treeList = response.menu;
            response.usermenu.forEach((item) => {
